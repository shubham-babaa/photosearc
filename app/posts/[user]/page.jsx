...
const Page = () => {
  ...
  const data=searchParams.get("person");
  // const router = useRouter();
  // const { key } = router.query; 
  
  const url = `https://pexelsdimasv1.p.rapidapi.com/v1/photos/${data}`;
  const options = {
    method: 'GET',
    headers: {
  ...
  return (
    <div className="max-w-md mx-auto bg-white shadow-lg rounded-lg overflow-hidden my-5 overflow-x-hidden bg-gradient-to-r to-cyan-900 from-gray-900 mx-1">
